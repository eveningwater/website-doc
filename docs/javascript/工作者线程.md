...
> 注意 Jake Archibald 在 Google Developers 网站有一篇关于网络/缓存策略的好文章《[离线指南](https://web.dev/offline-cookbook/)》,掘金已有翻译文章，详见[这里](https://juejin.cn/post/6844903731662848008)查看。
