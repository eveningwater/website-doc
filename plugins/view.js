...
function isDom(el) {
    return isObject(HTMLElement) ? el instanceof HTMLElement : el && isObject(el) && el.nodeType === 1 && isString(el.nodeName) || el instanceof HTMLCollection || el instanceof NodeList;
}
